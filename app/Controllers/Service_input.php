...
class Service_input extends Cdms_controller {
    ...
    */
    ...
    public function test() {
        ...
        // echo "ser_id (ไม่มี ถ้า service_input) : <br>";
        // echo "Importer ID : " . $ser_dri_id_in . "<br>";
        // echo "Exporter ID : " . $ser_dri_id_out . "<br>";
        // echo "Import car ID : " . $ser_car_id_in . "<br>";
        // echo "Export car ID : " . $ser_car_id_out . "<br>";

        // time format : 2022-01-08T14:00
        // echo "Arrivals date : " . $ser_arrivals_date . "<br>";
        // echo "Departure date (cut-off) : " . $ser_departure_date . "<br>";

        // echo "Arrivals location : " . $ser_arrivals_location . "<br>";
        // echo "Departure location : " . $ser_departure_location . "<br>";

        // if new con id = "new"
        echo "Container id : " . $con_id . "<br>";
        // echo "ถ้า new Container number : " . $con_number . "<br>";
        // echo "Service container id (ไม่มี): " . "<br>";
        // echo "Container type : " . $con_cont_id . "<br>";
        // echo "Container status : " . $con_stac_id . "<br>";
        // echo "Max weight : " . $con_max_weight . "<br>";
        // echo "Tare weight : " . $con_tare_weight . "<br>";
        // echo "Net weight : " . $con_net_weight . "<br>";
        // echo "Current weight : " . $ser_weight . "<br>";
        // echo "Cube : " . $con_cube . "<br>";
        // echo "Container size id : " . $con_size_id . "<br>";

        // if new agent id = BLANK
        // echo "Agent id : " . $agn_id . "<br>";
        // echo "Agent name : " . $agn_company_name . "<br>";
        // echo "Agent tax number : " . $agn_tax . "<br>";
        // echo "Agent address : " . $agn_address . "<br>";
        // echo "Agent firstname : " . $agn_firstname . "<br>";
        // echo "Agent lastname : " . $agn_lastname . "<br>";
        // echo "Agent tel. : " . $agn_tel . "<br>";
        // echo "Agent email : " . $agn_email . "<br>";

        // if new cus id = "new"
        // echo "Customer id : " . $cus_id . "<br>";
        // echo "Customer name : " . $cus_company_name . "<br>";
        // echo "Customer tax number : " . $cus_tax . "<br>";
        // echo "Customer address : " . $cus_address . "<br>";
        // echo "Customer firstname : " . $cus_firstname . "<br>";
        // echo "Customer lastname : " . $cus_lastname . "<br>";
        // echo "Customer tel. : " . $cus_tel . "<br>";
