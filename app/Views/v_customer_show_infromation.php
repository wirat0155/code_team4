    ...
    <div class="flex items-center justify-between p-3 pl-4 my-8 bg-dark text-white rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
        <div class="items-center container">
            ...
            <div class="float-right">
                <!-- ปุ่มแก้ไข -->
                <a href="<?php echo base_url() . '/public/Customer_edit/customer_edit/' . $arr_customer[0]->cus_id ?>" class="btn btn-warning px-2 mr-1 text-sm ">แก้ไขข้อมูล</a>
                <!-- ปุ่มลบ -->
                <button type="button" class="btn btn-danger px-2 text-sm" data-toggle="modal" data-target="#Modal_Confirm" onclick="get_id(<?php echo $arr_customer[0]->cus_id ?>)">ลบข้อมูล
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="container-sm px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="container">
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cus_company_name" name="cus_company_name" placeholder="บริษัท" value="<?php echo $arr_customer[0]->cus_company_name ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cus_branch" name="cus_branch" placeholder="สาขา" value="<?php echo $arr_customer[0]->cus_branch ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="cus_address" name="cus_address" placeholder="ที่ตั้งบริษัท" rows="3" value="<?php echo $arr_customer[0]->cus_address ?>" readonly><?php echo $arr_customer[0]->cus_address ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cus_tax" name="cus_tax" placeholder="หมายเลขผู้เสียภาษี" maxlength="13" pattern="[0-9]{13}" value="<?php echo $arr_customer[0]->cus_tax ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cus_firstname" name="cus_firstname" placeholder="ชื่อจริง" value="<?php echo $arr_customer[0]->cus_firstname ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cus_lastname" name="cus_lastname" placeholder="นามสกุล" value="<?php echo $arr_customer[0]->cus_lastname ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="tel" class="form-control" id="cus_tel" name="cus_tel" placeholder="1234567890" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" maxlength="10" value="<?php echo $arr_customer[0]->cus_tel ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="px-3 form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="cus_email" name="cus_email" placeholder="อีเมล" value="<?php echo $arr_customer[0]->cus_email ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
