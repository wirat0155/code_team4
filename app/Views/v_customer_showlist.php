    ...
    <div class="content">
        <div class="page-inner">
            ...
            <div class="row">
                ...
                <form id='form_date' action="<?php echo base_url() . '/Customer_show/customer_show_ajax' ?>" method="post" class="ml-auto mr-3 text-right">
                                            ...
                                            <td class="text-left" width='15px'>
                                                <div class="ui dropdown text-center p-2" style="border: 1px solid #ddd; width: 20px; height: 20px; border-radius: 50%" onclick="show_service_menu(<?php echo $arr_customer[$i]->cus_id ?>)">
                                                    ...
                                                    <div class="menu cus_id_<?php echo $arr_customer[$i]->cus_id ?>" style="right: 0;left: auto;">
                                                        ...
                                                        <div class="item" onclick="location.href='<?php echo base_url() . '/Customer_edit/customer_edit/' . $arr_customer[$i]->cus_id ?>';">
