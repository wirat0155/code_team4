            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm text-center"
                        onclick="service_detail(<?php echo $arr_service[$i]->ser_id ?>)">
                    ...
                    <td class="px-4 py-3 text-sm text-center"
                        ...
                        <!-- ปุ่มแก้ไข -->
                        <a href="<?php echo base_url() . '/public/Service_edit/service_edit/' . $arr_service[$i]->ser_id ?>"
                            class="btn btn-warning p-2"><i class="bi bi-pencil-square"></i></a>
                        <!-- ปุ่มลบ -->
