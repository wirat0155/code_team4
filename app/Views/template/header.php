        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul class="mt-6">
            ...
            <li class="relative px-6 py-3" <?php if($_SESSION['menu'] == 'Service_show') echo 'style="background-color: #D2D5DA"'?>>
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100 <?php if($_SESSION['menu'] == 'Service_show') echo 'text-gray-800'?>" href="<?php echo base_url() . '/public/Service_show'?>">
            ...
            <li class="relative px-6 py-3" <?php if($_SESSION['menu'] == 'Agent_show') echo 'style="background-color: #D2D5DA"'?>>
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100 <?php if($_SESSION['menu'] == 'Agent_show') echo 'text-gray-800'?>" href="<?php echo base_url() . '/public/Agent_show'?>">
